...
<body>
	...
	<p>Génération automatique des paires</p>
	...
	$maxlignesNS = intval($nbpaires/2);
	$maxlignesEO = $nbpaires - $maxlignesNS;
	...
	for ( $i = 1; $i <= $maxlignesEO; $i++ ) {
		$idj2 = $i*4 -2;
		$idj4 = $idj2 + 2;
		$sql = "INSERT $tab_pairesEO ( idtournoi, num, idj2, idj4 ) VALUES ( '$idtournoi', '$i', '$idj2', '$idj4' );";
		$res = $dbh->query($sql);
		};
	$dbh = null;
	?>
