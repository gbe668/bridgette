<?php
	...
	if ( isset($_POST['pseudo']) ){
		...
		if ( $nbl > 0 ) {
			...
			// nouveau pseudonyme
			$sql = "INSERT into `$tab_directeurs` (pseudo, password, droits) VALUES ('$pseudo', '".hash('sha256', $password)."', 'admin');";
			$res = $dbh->query($sql);
			if($res){
...
<body>
	...
	<h2>Ajout d'un nouvel administrateur</br>Entrez les identifiants de connexion</h2>
	<p>&nbsp;</p>
